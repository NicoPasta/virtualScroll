class VirtualScroll {
    constructor(c, list, itemGenerator, cacheCount) {
        ...
        this.list = list; // raw list
        this.cacheList = []; // cache list
        this._offset = 0; // offset
        this.offsetToEdge = 0; // offsettoedge
        this.cacheCount = cacheCount || 5; //前后缓存个数
        this.itemGenerator = itemGenerator; // 生产列表元素
        this.contentHeight = 0; // 列表元素总宽度
    ...
    render(_offset) {
        ...
        //   若监听到事件后重新渲染，然后计算出wrapper的向上偏移量
